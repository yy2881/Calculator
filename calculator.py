...
Display = Entry(root,font=('arial',30,'bold'), fg='white', bg='green', 
                justify='right',bd=30,textvariable=txt_input)
...
btnC = Button(root,padx=30,pady=15,bd=8,fg='black',font=('arial',30,'bold'),\
    text='C',command=lambda:clear()).grid(row=1,column=3)
...
btnplus = Button(root,padx=30,pady=15,bd=8,fg='black',font=('arial',30,'bold'),\
    text='+',command=lambda:btn('+')).grid(row=2,column=3)
...
btnminus = Button(root,padx=38,pady=15,bd=8,fg='black',font=('arial',30,'bold'),\
    text='-',command=lambda:btn('-')).grid(row=3,column=3)
...
btnmultiply = Button(root,padx=34,pady=15,bd=8,fg='black',font=('arial',30,'bold'),\
    text='x',command=lambda:btn('*')).grid(row=4,column=3)



#row5
btnequals = Button(root,padx=95,pady=15,bd=8,fg='black',font=('arial',30,'bold'),\
    text='=',command=lambda:Equal()).grid(row=5,column=0,columnspan=2)
btnob= Button(root,padx=38,pady=15,bd=8,fg='black',font=('arial',30,'bold'),\
    text='(',command=lambda:btn('(')).grid(row=5,column=2)
btnclosebracket = Button(root,padx=38,pady=15,bd=8,fg='black',font=('arial',30,'bold'),\
    text=')',command=lambda:btn(')')).grid(row=5,column=3)
